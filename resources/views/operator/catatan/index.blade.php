<x-layouts.operator.app>
    <section class="header">
        <h2 class="header-title">Data Catatan Harian Dosen</h2>
    </section>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header flex items-end justify-end">
                    <a href="{{ url('operator/catatan/create') }}" class="btn btn-success">
                    ...
                    <table class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ url('operator/catatan/edit',$catatan->id) }}" class="btn btn-primary">
                            ...
                            <x-modal.delete id="hapus{{ $catatan->id}}" action="{{ url('operator/catatan/delete',$catatan->id) }}" />
                            @endforeach
                        </tbody>
                    </table>
                </div>
