<x-layouts.operator.app>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('operator/pengabdian/update',$list->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-input.select label="Status Penelitian" name="status_pengapdian" placeholder="Status Penelitian">
                                    <option value="">--- Pilih Status Penelitian ---</option>
                                    <option value="Baru" @if ($list->status_pengapdian == 'Baru') selected @endif>Baru</option>
                                    <option value="Diverifikasi" @if ($list->status_pengapdian == 'Diverifikasi') selected @endif>Diverifikasi</option>
                                    <option value="Ditolak" @if ($list->status_pengapdian == 'Ditolak') selected @endif>Ditolak</option>
                                </x-input.select>
                            </div>
